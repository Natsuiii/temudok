    ...
    public function run(): void
    {
        ...
        Article::factory()->create([
            ...
            'content' => "Kehamilan ektopik adalah kehamilan yang terjadi di luar rahim. Pada kehamilan normal, telur yang sudah dibuahi akan melalui saluran tuba falopi yang menghubungkan indung telur dengan rahim menuju ke rahim. Telur tersebut akan melekat pada rahim dan mulai tumbuh menjadi janin. Namun pada kehamilan ektopik, telur yang sudah dibuahi akan menempel dan tumbuh di tempat yang tidak semestinya.\n\n".
                        "Penyebab hamil di luar kandungan bisa beragam, seperti riwayat hamil ektopik sebelumnya, masih menggunakan alat kontrasepsi spiral dan pil progesteron saat hamil, atau adanya kerusakan dari saluran telur. Beberapa faktor risiko yang dapat menyebabkan gangguan saluran ini, di antaranya merokok, penyakit radang panggul, dan endometriosis.\n\n".
                        "Penanganan kehamilan ektopik dilakukan dengan operasi atas pertimbangan dokter spesialis kebidanan dan kandungan. Oleh karena kehamilan ektopik dapat mengancam nyawa, maka deteksi dini dan keputusan untuk mengakhiri kehamilan disesuaikan dengan prosedur yang disarankan oleh pihak rumah sakit. Pengobatan kehamilan ektopik dapat dilakukan dengan cara terapi obat-obatan ataupun operasi.\n",
        ...
        Article::factory()->create([
            ...
            'content' => "Proses melahirkan normal yang dialami setiap ibu hamil bisa berbeda-beda. Namun, pada dasarnya ada 3 tahapan proses yang umumnya dilalui oleh ibu hamil sebelum akhirnya bertemu dengan buah hati tercinta. Tahapan proses melahirkan normal dimulai ketika ibu hamil mulai mengalami kontraksi rahim. Namun, perlu diingat bahwa kontraksi ini berbeda dengan kontraksi palsu.\n\n".
                        "1. Tahapan pertama\nTahapan pertama diawali dengan pelebaran leher rahim, kontraksi yang kuat, dan meningkatnya intensitas rasa sakit. Kadang, tahap ini juga diikuti dengan pecahnya ketuban. Pada fase ini, ibu yang melahirkan umumnya membutuhkan pendamping.\n\n2. Tahapan Kedua\nTahapan ini adalah proses mendorong bayi agar keluar dari tubuh ibu. Pada tahap ini, bukaan leher rahim sudah penuh dan semua tenaga harus dikerahkan untuk mengeluarkan bayi.\n\n".
                        "3. Tahapan ketiga\nDi fase ini, bayi telah lahir, namun persalinan belum sepenuhnya usai. Pada tahap ketiga proses melahirkan normal, Bumil harus menunggu hingga plasenta keluar dari rahim. Plasenta biasanya akan keluar dalam waktu 5–10 menit setelah bayi lahir. Namun, ada juga yang baru keluar setelah 30–60 menit. Setelah bayi dan plasenta keluar, bidan akan menjahit luka robekan di jalan lahir. Ibu juga bisa mulai menyusui sang buah hati.\n",
        ...
        Article::factory()->create([
            ...
            'content' => "Tindik lidah merupakan salah satu bentuk ekspresi diri yang cukup populer di kalangan remaja. Di balik alasan estetika, tindik lidah bisa berbahaya bagi kesehatan, terutama kesehatan gigi dan mulut. Proses tindik lidah dilakukan dengan cara menusuk lidah menggunakan jarum untuk membuat lubang kecil. Setelah itu, perhiasan berbentuk cincin atau bulatan kecil akan dimasukkan ke dalam lubang tersebut.\n\n".
                        "Tindik lidah pada awalnya bisa menyebabkan nyeri, bengkak, dan air liur berlebih. Saat perhiasan menembus jaringan lunak, tindikan di lidah bisa menimbulkan risiko yang lebih berbahaya daripada tindikan di bagian tubuh lain, misalnya telinga atau hidung. Ini karena perawatan tindik lidah lebih sulit dan luka tindikan lebih mudah terinfeksi. Tindikan di lidah juga bisa memicu terjadinya perdarahan saat pembuluh darah tertusuk jarum selama proses penindikan.\n\n".
        ...
        Article::factory()->create([
            ...
            'content' => "Gigi berlubang termasuk keluhan umum pada anak-anak dan sebaiknya tidak boleh disepelekan karena bisa menyebabkan gigi nyeri atau gigi copot, namun juga bahaya kesehatan lainnya. Penyebab atau faktor gigi berlubang pada anak sangat banyak, antara lain bakteri dalam plak akibat anak jarang menyikat gigi, sehingga terjadi penumpukan plak di dalam rongga mulut.\n\n".
                        "Dalam pencegahannya, fluoride termasuk salah satu mineral yang dibutuhkan untuk mencegah gigi berlubang, sehingga gigi anak sangat penting disikat dengan pasta gigi yang mengandung fluoride. Fluoride adalah mineral yang terjadi secara alami, membantu mencegah gigi berlubang pada anak-anak dan orang dewasa dengan membuat permukaan luar gigi (enamel) lebih kuat terhadap serangan asam yang menyebabkan kerusakan gigi.\n\n".
                        "Selain itu, orang tua juga harus sadar pentingnya kesehatan gigi susu bagi pertumbuhan anak secara keseluruhan dan pentingnya gigi susu untuk kesehatan gigi tetap kemudian. Oleh sebab itu, mulailah kebiasaan baik untuk membersihkan rongga mulut, makan makanan sehat, tidak memperkenalkan atau mengontrol makanan atau minuman manis sejak dini, serta membiasakan sikat gigi bersama keluarga.\n",
