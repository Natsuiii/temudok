...
<div class="container p-4">
    <h4 class="fw-bold mb-2">Riwayat Pemesanan</h4>
            ...
            <div class="d-flex flex-wrap" style="gap: 20px;">
                ...
                <div class="d-flex flex-row align-items-center justify-content-between w-100" style="border: 1px solid #ddd; border-radius: 10px; padding: 15px; gap: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    <div class="d-flex align-items-center" style="gap: 15px;">
                        ...
                        <div>
                            <h5 class="m-0 fw-bold" style="font-size: 16px;">Dr. Fendy Wijaya</h5>
                            <p class="m-0" style="font-size: 14px; color: #666;">Dokter Umum</p>
                            <p class="m-0" style="font-size: 14px; color: #007bff;">Rating: 4.5/5</p>
                        </div>
                    </div>
                    <div>
                        <p class="m-0" style="font-size: 14px;">Tanggal Booking: <strong>12 Desember 2024</strong></p>
                        <p class="m-0" style="font-size: 14px;">Harga: <strong>Rp 50.000</strong></p>
                    </div>
                    <div>
                        <a href="" class="btn btn-primary text-white fw-bold text-decoration-none">Link Zoom</a>
                    </div>
                </div>
