                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">If you want to add more, click <a
                                href="{{ route('category.create') }}" rel="noopener noreferrer nofollow">here</a>.</h6>
                    </div>
                    <div class="card-body overflow-auto">
                        <!-- Tombol untuk melakukan bulk destroy -->
                        <form action="{{ route('category.bulkDestroy') }}" method="POST" id="bulk-delete-form">
                            @csrf
                            @method('DELETE')
                        ...
                        <table id="user-table" class="table table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        <td><input type="checkbox" class="row-select" data-id="{{ $category->id }}"></td>
