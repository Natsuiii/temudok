                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">If you want to add more, click <a
                                href="{{ route('schedule.create') }}" rel="noopener noreferrer nofollow">here</a>.</h6>
                    </div>
                    <div class="card-body overflow-auto">
                        <!-- Tombol untuk melakukan bulk destroy -->
                        <form action="{{ route('schedules.bulkDestroy') }}" method="POST" id="bulk-delete-form">
                            @csrf
                            @method('DELETE')
