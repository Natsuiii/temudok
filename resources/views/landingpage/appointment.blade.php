...
<div class="container p-4">
    <div class="row">
        <!-- Daftar Spesialis -->
        <div style="display: flex; gap: 10px; padding: 10px; background-color: #f8f9fa; border-radius: 8px; margin-bottom: 20px; overflow-x: auto;">
        ...
        <div class="col-md-12">
            <h5>Daftar Dokter</h5>
            <div id="doctor-list" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: space-between; margin-bottom: 50px;">
